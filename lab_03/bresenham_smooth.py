...
# Алгоритм Брезенхэма (со сглаживанием) для теста
def test_brez_smooth(ps, pf):
    L = 100
    dx = pf[0] - ps[0]
    dy = pf[1] - ps[1]
    sx = sign(dx)
...
# # Алгоритм Брезенхэма (со сглаживанием)
# def draw_line_brez_smooth(canvas, ps, pf, fill):
#     I = 100
#     fill = get_rgb_intensivity(canvas, fill, I)
#     dx = pf[0] - ps[0]
#     dy = pf[1] - ps[1]
#     sx = sign(dx)
#     sy = sign(dy)
