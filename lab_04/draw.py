...
def add_ellipse(canvas, color_fg, algorithm, xc, yc, ra, rb, draw = True):
    ...
    if alg == 0:
        canonical_ellipse(xc, yc, ra, rb, color_fg, canvas, draw)
    elif alg == 1:
        parameter_ellipse(xc, yc, ra, rb, color_fg, canvas, draw)
    elif alg == 2:
        bresenham_ellipse(xc, yc, ra, rb, color_fg, canvas, draw)
    elif alg == 3:
        midpoint_ellipse(xc, yc, ra, rb, color_fg, canvas, draw)
    else:
        lib_ellipse(canvas, xc, yc, ra, rb, color_fg)
        return
...
def add_circle(canvas, color_fg, algorithm, xc, yc, r, draw = True):
    ...
    if alg == 0:
        canonical_сircle(xc, yc, r, color_fg, canvas, draw)
    elif alg == 1:
        parameter_circle(xc, yc, r, color_fg, canvas, draw)
    elif alg == 2:
        bresenham_circle(xc, yc, r, color_fg, canvas, draw)
    elif alg == 3:
        midpoint_circle(xc, yc, r, color_fg, canvas, draw)
    else:
        lib_ellipse(canvas, xc, yc, r, r, color_fg)
        return
